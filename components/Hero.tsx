...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-16 overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full text-center space-y-12">
        {/* Pricing Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900/50 border border-gray-800 rounded-full text-sm text-gray-300">
